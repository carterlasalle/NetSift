    ...
    for packet in packets:
        ...
        rows.append(
            [
                str(packet.index),
                moment,
                _endpoint(packet.source, packet.source_port),
                _endpoint(packet.destination, packet.destination_port),
                packet.highest_protocol.upper(),
                str(packet.captured_length),
                ("! " if packet.malformed else "") + packet.info,
            ]
        )
